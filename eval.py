        ...
        while retry_count < max_retries and not success:
            try:
                ...
                if eval_data:
                    ...
                    required_keys = ["Comprehensiveness", "Diversity", "Empowerment", "Overall Winner"]
...
if __name__ == "__main__":
    ...
    output_file = "/home/hungpv/projects/TN/LIGHTRAG/eval/results/eval_results/direct_evaluation_results.json"
